...
// Documents the JWT bearer scheme in the OpenAPI spec so Scalar renders an
...
// Authorize token is sent only where it's needed (the alert endpoints), not on
// the public rates/convert/auth/health routes.
